...
const translations = {
  pt: {
    ...
    'dashboard.insightsDesc': 'Sinais rápidos para decidir o que fazer hoje.',
    'dashboard.alertOverBudget': '{category} passou do orçamento em {amount}.',
    'dashboard.alertNearBudget': '{category} já usou {percent}% do orçamento.',
    'dashboard.alertNegativeBalance': 'O saldo disponível está negativo neste momento.',
    'dashboard.alertPayday': 'Faltam {days} dias para o próximo pagamento. Disponível: {amount}.',
    'dashboard.alertTopCategory': 'Maior gasto do ciclo: {category}, com {amount}.',
    'dashboard.alertDailyPace': 'Seu gasto diário médio está acima do ritmo ideal para o restante do ciclo.',
    'dashboard.alertTopGrowingCategory': 'Categoria que mais subiu: {category}, aumento de {amount}.',
    'dashboard.estimatedSavings': 'Economia estimada',
    'dashboard.estimatedSavingsDesc': 'Saldo disponível considerando o ciclo atual.',
    ...
    'history.exportBy': 'Exportar por',
    'history.exportMonth': 'Mês',
    'history.exportYear': 'Ano',
    'history.showArchived': 'Ver arquivados',
    'history.hideArchived': 'Voltar para ativos',
    'history.save': 'Salvar',
    ...
    'history.csvSummary': 'Resumo',
    'history.csvPeriod': 'Período',
    'history.csvFilename': 'transacoes.csv',
    'history.archived': 'Arquivadas',
    'history.active': 'Ativas',
    'history.restore': 'Restaurar',
    'history.noTransactions': 'Nenhuma transação encontrada.',
    'history.noTransactionsDesc': 'Ajuste os filtros ou registre novos movimentos para preencher o histórico.',
    'history.noArchived': 'Não há transações arquivadas para este período.',
    'history.year': 'Ano',
    ...
    'stats.categoryGrowth': 'Categoria que mais subiu',
    'stats.economyEstimate': 'Economia estimada',
    'stats.dailyPace': 'Ritmo diário ideal',
    'stats.categoryGrowthDesc': 'A categoria que cresceu mais em relação ao ciclo anterior.',
    'stats.economyDesc': 'Saldo provável se o padrão atual se mantiver.',
  ...
  en: {
    ...
    'dashboard.insights': 'Insights',
    'dashboard.insightsDesc': 'Quick signals to decide what to do today.',
    'dashboard.alertOverBudget': '{category} is over budget by {amount}.',
    'dashboard.alertNearBudget': '{category} already used {percent}% of its budget.',
    'dashboard.alertNegativeBalance': 'Available balance is negative right now.',
    'dashboard.alertPayday': '{days} days until next payday. Available: {amount}.',
    'dashboard.alertTopCategory': 'Top spending this cycle: {category}, with {amount}.',
    'dashboard.alertDailyPace': 'Your average daily spending is above the ideal pace for the rest of the cycle.',
    'dashboard.alertTopGrowingCategory': 'Top growing category: {category}, increased by {amount}.',
    'dashboard.estimatedSavings': 'Estimated savings',
    'dashboard.estimatedSavingsDesc': 'Available balance for the current cycle.',
    // History
    ...
    'history.exportBy': 'Export by',
    'history.exportMonth': 'Month',
    'history.exportYear': 'Year',
    'history.showArchived': 'View archived',
    'history.hideArchived': 'Back to active',
    'history.save': 'Save',
    ...
    'history.csvSummary': 'Summary',
    'history.csvPeriod': 'Period',
    'history.csvFilename': 'transactions.csv',
    'history.archived': 'Archived',
    'history.active': 'Active',
    'history.restore': 'Restore',
    'history.noTransactions': 'No transactions found.',
    'history.noTransactionsDesc': 'Adjust the filters or record a new movement to fill the history.',
    'history.noArchived': 'There are no archived transactions for this period.',
    'history.year': 'Year',
    ...
    'stats.categoryGrowth': 'Top growing category',
    'stats.economyEstimate': 'Estimated savings',
    'stats.dailyPace': 'Ideal daily pace',
    'stats.categoryGrowthDesc': 'The category with the biggest increase compared to the previous cycle.',
    'stats.economyDesc': 'Available balance if the current pattern continues.',
